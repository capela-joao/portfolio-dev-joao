...
export const techCategories = [
  ...
  },
  {
    title: 'Tools',
    techs: [
      { icon: '/assets/stacks/icons8-git-48.png', name: 'Git' },
      {
        icon: '/assets/stacks/icons8-visual-studio-code-48.png',
        name: 'VS Code',
      },
      { icon: '/assets/stacks/icons8-npm-48.png', name: 'npm' },
      { icon: '/assets/stacks/Icon.png', name: 'Vercel' },
      { icon: '/assets/stacks/render.jpeg', name: 'Render' },
    ],
  },
];
